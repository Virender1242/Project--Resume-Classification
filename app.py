...
def extract_skills(resume_text):
    ...
    data = pd.read_csv(r"C:\Users\LENOVO\Project Resume Recognation\skills.csv") # reading the csv file
...
# MAIN CODE
import pickle as pk
model = pk.load(open(r'C:\Users\LENOVO\Project Resume Recognation\modelDT.pkl', 'rb'))
Vectorizer = pk.load(open(r'C:\Users\LENOVO\Project Resume Recognation\vector.pkl', 'rb'))
...
for doc_file in upload_file:
    if doc_file is not None:
        ...
        if prediction == 0:
            prediction = 'PeopleSoft'
        elif prediction == 1:
            prediction = 'SQL Developer'
        elif prediction == 2:
            prediction = 'React JS Developer'
        elif prediction == 3:
            prediction = 'Workday'
